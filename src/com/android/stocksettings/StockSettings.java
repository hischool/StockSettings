...
public class StockSettings extends PreferenceActivity implements OnPreferenceChangeListener {
	...
	//酷派8297
	private static final String Coolpad8297 = SystemProperties.get("ro.product.mod_device");
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		if ((!this.Coolpad8297.equals("8297_xs")) || (!this.XS.equals("weibo.com/acexs"))) {
			Toast.makeText(getApplicationContext(),
					"您可能是盗版ROM受害者，请前往MIUI官网下载正版ROM，认准作者XS！", Toast.LENGTH_SHORT)
					.show();
			finish();
		}
		...
		if (preference == mCrtLockscreen) {
			if (mCrtLockscreen.isChecked()) {
				Settings.System.putInt(getContentResolver(),
						"allow_crt_lockscreen", 1);
			} else {
				Settings.System.putInt(getContentResolver(),
						"allow_crt_lockscreen", 0);
			}
		}
